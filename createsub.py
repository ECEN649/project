...
for seg_loss in seg_loss_group_154:
    loc_folder = 'pred154_loc'+str(seg_loss)
    loc_folders.append(loc_folder)
...
for seg_loss in seg_loss_group_50:
    loc_folder = 'pred50_loc'+str(seg_loss)
    loc_folders.append(loc_folder)
